  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-pink-50 to-amber-50 flex">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('https://static.readdy.ai/image/db4f710102ca6cc45db44808c8658987/514ce0e5537ea676b8d526ca4f8b3335.png')",
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative">
        ...
        <div className="w-full max-w-md">
          ...
          <p className="text-slate-500 text-base mb-8">
            還沒有帳號？{" "}
            <Link to="/signup" className="text-rose-500 hover:text-rose-600 font-semibold cursor-pointer">
              免費註冊
            </Link>
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3.5 bg-white border border-slate-200 rounded-xl text-base text-slate-800 placeholder-slate-400 focus:outline-none focus:border-rose-300 focus:ring-2 focus:ring-rose-100 transition-all"
                />
              </div>
            </div>
            ...
            <div className="flex justify-end">
              <Link to="/forgot-password" className="text-sm text-slate-400 hover:text-rose-500 cursor-pointer transition-colors">
                忘記密碼？
              </Link>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-4 bg-gradient-to-r from-rose-400 to-pink-500 text-white font-bold rounded-xl hover:from-rose-300 hover:to-pink-400 transition-all text-base whitespace-nowrap cursor-pointer disabled:opacity-60"
            >
              {loading ? "登入中..." : "登入"}
            </button>
          </form>
